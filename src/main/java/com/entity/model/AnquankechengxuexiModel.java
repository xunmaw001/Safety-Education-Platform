 ...
 */
public class AnquankechengxuexiModel  implements Serializable {
	...
	public void setZiyuanlaiyuan(String ziyuanlaiyuan) {
		this.ziyuanlaiyuan = ziyuanlaiyuan;
	}
